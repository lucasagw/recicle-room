...
//        String valor = AdicionarFragmentArgs.fromBundle(getArguments()).getTexto();
//        TextView textView = view.findViewById(R.id.texto_adicionar);
...
//        return view;
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        String valor = AdicionarFragmentArgs.fromBundle(getArguments()).getTexto();
        TextView tv = view.findViewById(R.id.texto_adicionar);
        tv.setText(valor);
    }
